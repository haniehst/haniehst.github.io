...
| <img src="{{'assets/img/portfolio/technologies/scrapy.png' | relative_url}}" width="60" height="60"> | **SCRAPY** is used for crawling data from twitter. |
| <img src="{{'assets/img/portfolio/technologies/selenium.png' | relative_url}}" width="60" height="60"> | **SELENIUM** is a standalone browser. |
| <img src="{{'assets/img/portfolio/technologies/bs.jpg' | relative_url}}" width="60" height="60"> | **BEAUTIFUL SOUP** is used for parsing HTML and XML documents. |
